 ...
 * [Gamestate] permission required.
 */
function xpRiseListener(callback:string):boolean;
/**
 ...
 * [Gamestate] permission required.
 */
function xpCounterListener(callback:string):boolean;
/**
 ...
 * [Gamestate] permission required.
 */
function resetAreaListeners():boolean;
/**
 * Gets whether the location of the specified interface is known
 * [Gamestate] permission required.
 */
function interfaceFound(interfaceName:string):boolean;
/**
 * Gets whether alt1 is currently searching the interface in the client.
 * [Gamestate] permission required.
 */
function interfaceSearching(interfaceName:string):boolean;
/**
 ...
 * [Gamestate] permission required.
 */
function findInterface(interfaceName:string):boolean;
/**
 ...
 * [Gamestate] permission required.
 */
function readInterface(interfaceName:string,data:string):string;
/**
 ...
 * [Gamestate] permission required.
 */
function readInterfaceStart(interfaceName:string,data:string):number;
/**
 * Removes the tooltip.
 * [Installed] permission required.
 */
 ...
 * [Installed] permission required.
 */
function deleteStream(callback:string):boolean;
/**
 ...
 * [Pixel] permission required.
 */
function streamRegion(callback:string,x:number,y:number,w:number,h:number):boolean;
/**
...
/**
 * [Only available in debug builds] Toggle Alt1 OCR debug output. Will create a new windows for every OCR call you do, so don't spam OCR to much aftre togling this.
 * [Pixel] permission required.
 */
function setOCRDebug(enabled:boolean):any;
/**
