...
export default class TooltipReader {
     ...
     */
    static checkPossible(buf: ImageData, up: boolean, far: boolean) {
        var mousepos = a1lib.getMousePosition();
    ...
    static getCaptArea(dir: -1 | 0 | 1, mousepos: a1lib.PointLike) {
        if (!mousepos) { mousepos = a1lib.getMousePosition(); }
    ...
    static readImage(img: ImgRef, mouseAbs: a1lib.PointLike, dir: -1 | 1) {
        ...
        var rect = null as a1lib.RectLike;
    ...
    static readBankItem(img: ImgRef, area: a1lib.RectLike) {
        var data = img.toData();
        var line1: ReturnType<typeof OCR.findReadLine> = null;
        var line2: ReturnType<typeof OCR.findReadLine> = null;
        var name = "";
        for (var a = 0; a < 2; a++) {
