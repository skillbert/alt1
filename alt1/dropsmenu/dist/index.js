(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["@alt1/dropsmenu"] = factory(require("@alt1/base"), require("@alt1/ocr"));
	else
		root["DropsMenuReader"] = factory(root["A1lib"], root["OCR"]);
...
module.exports=__webpack_require__("@alt1/base").ImageDetect.imageDataFromBase64("")
...
var imgs = a1lib.ImageDetect.webpackImages({
    loot: __webpack_require__("./imgs/lootbutton.data.png"),
    reset: __webpack_require__("./imgs/reset.data.png"),
    droptext: __webpack_require__("./imgs/droptext.data.png"),
    quantitytext: __webpack_require__("./imgs/quantitytext.data.png")
});
var font = __webpack_require__("../ocr/fonts/aa_8px_new.fontmeta.json");
var fontcolors = [
    [255, 255, 255],
    [30, 255, 0],
    [102, 152, 255],
...
var DropsMenuReader = /** @class */ (function () {
    function DropsMenuReader() {
        this.pos = null;
        this.items = [];
        this.onincrease = null;
    }
    DropsMenuReader.prototype.find = function (img) {
        if (!img) {
    ...
    DropsMenuReader.prototype.read = function (img) {
        if (!this.pos) {
            return null;
        }
        var buf;
